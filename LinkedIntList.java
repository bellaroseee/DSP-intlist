    ...
    public static void firstToLast(LinkedIntList L) {
        if (L.front != null) {
            if (L.front.next != null) {
                ...
                L.front = p.next;  //front points to 2nd ListNode
                while (back.next != null) {
                    back = back.next;
                }
                back.next = p;
                p.next = null; //last ListNode next points to 1st ListNode
            }
        }
    }
    ...
    public static LinkedIntList concatenated(LinkedIntList A, LinkedIntList B) {
        ...
        if (A.front == null) {
            if (B.front == null) {
                ...
                front = new ListNode(q.data);
                back = front;
                q = q.next;
                while (q != null) {
                    back.next = new ListNode(q.data);
                    back = back.next;
                    q = q.next;
                }
                return new LinkedIntList(front);
